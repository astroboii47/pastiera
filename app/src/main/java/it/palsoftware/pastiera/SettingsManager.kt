...
object SettingsManager {
    ...
    private const val KEY_SYM_AS_CTRL_IN_TEXT_FIELDS = "sym_as_ctrl_in_text_fields"
    ...
    private const val DEFAULT_SYM_AS_CTRL_IN_TEXT_FIELDS = false
    ...
    fun getSymAsCtrlInTextFields(context: Context): Boolean =
        getPreferences(context).getBoolean(
            KEY_SYM_AS_CTRL_IN_TEXT_FIELDS,
            DEFAULT_SYM_AS_CTRL_IN_TEXT_FIELDS
        )

    fun setSymAsCtrlInTextFields(context: Context, enabled: Boolean) {
        getPreferences(context).edit()
            .putBoolean(KEY_SYM_AS_CTRL_IN_TEXT_FIELDS, enabled)
            .apply()
    }
